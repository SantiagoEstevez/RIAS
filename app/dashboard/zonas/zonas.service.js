...
var ZonasService = (function () {
    ...
    ZonasService.prototype.getAllZonas = function () {
        return this.http.get(this.url)
            .toPromise()
            .then(function (response) { return response.json().data; })
            .catch(this.handleError);
    };
    ZonasService.prototype.getPlaces = function () {
        console.log("ATES DE");
        var url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670522,151.1957362&radius=500&type=restaurant&keyword=cruise&key=AIzaSyCVOAuarlU-eZpS_Ex0DAotelt2M0yOEn8';
        return this.http.get(url).map(function (res) {
            console.log(res);
        });
    };
    ZonasService.prototype.getPlaces2 = function () {
        console.log("ATES DE");
