...
var ZonasComponent = (function () {
    ...
    ZonasComponent.prototype.ngOnInit = function () {
        ...
        //https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670522,151.1957362&radius=500&type=restaurant&keyword=cruise&key=AIzaSyCVOAuarlU-eZpS_Ex0DAotelt2M0yOEn8
        //Eventos del circulo
    ...
    ZonasComponent.prototype.getZonas = function () {
        var _this = this;
        this.zonasService.getAllZonas().then(function (zonas) { return _this.zonas = zonas; });
    ...
    ZonasComponent.prototype.getPlaces = function () {
        //this.zonasService.getPlaces().subscribe(place => {
        //    console.log(place);
        //});
        this.zonasService.getPlaces2().then(function (place) {
            console.log(place);
        });
    };
