...
var SensoresComponent = (function () {
    function SensoresComponent(ciudadesService, SensoresService) {
    ...
    SensoresComponent = __decorate([
        ...
        __metadata('design:paramtypes', [ciudades_service_1.CiudadesService, sensores_service_1.SensoresService])
    ], SensoresComponent);
